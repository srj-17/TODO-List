...
//user.addTodayTodos("hello", "this is the todo of todods", "2011-10-1", 1, "ok these are notes for this project", ['hello', 'these', 'are', 'things', 'to', 'do'])
//setTimeout(() => {
//    user.getTodayTodos().getTodos().at(0).edit("bello", "this is the todo of todods", "2011-10-1", 1, "ok these are notes for this project", ['hello', 'these', 'are', 'things', 'to', 'do'])
//}, 3000);   
